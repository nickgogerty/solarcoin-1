...
- 523 Character Transaction Messaging
- Initially 100 coins per block initial rewards, halving every 525,600 (once a year) blocks. 
 -Now POST (Proof of Stake Time) 2% target return
